...
HOST = "https://ac-hk-projet-api-1021317796643.europe-west1.run.app"
...
def generate_feedback_dashboard(feedback_df):
    """
    Generate histogram for feedback dashboard.
    """
...
with tab4:  
    ...
    try:
        ...
        st.write(f"Total number of feedbacks: {len(feedback_df)}")
        st.write(f"Average rating: {feedback_df['Rating'].mean():.2f} ⭐")
