...
class RAGEvaluator:
    def __init__(self, sample_size=10, api_url=API_URL):
        ...
        try:
            ...
            self.stopwords = set()  # Empty set if French stopwords not available
    ...
    def get_random_samples(self):
        ...
        # If fewer documents than the requested sample size
    ...
    def generate_questions(self, documents):
        ...
        for doc in documents:
            ...
            # Create a question and reference answer using the Gemini API
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    if not reference_answer or len(reference_answer) < 10:
                        # Extract a relevant passage for the reference answer
                        ...
                        if extract_response.status_code == 200:
                            ...
                            reference_answer = content  # Fall back to full content
                    
                    questions.append({
                        "document": doc,
                        "question": generated_question,
                        "expected_answer": reference_answer,
                        "full_content": content  # Keep the full content for additional analysis
                    })
                except:
                    # If JSON parsing fails, use traditional approach
    ...
    def evaluate_retrieval(self, question, sources, expected_doc):
        ...
        # Check if expected content is in retrieved sources
        # Using a more lenient text overlap method
        ...
        for content in retrieved_contents:
            ...
            # More lenient threshold (30% instead of 50%)
    ...
    def text_overlap(self, text1, text2):
        ...
        # Filter out stopwords and short words for important tokens
        ...
        # Calculate overlap of important tokens if available
    ...
    def evaluate_generation(self, generated_answer, expected_answer, full_content=None):
        ...
        # Try both the focused expected answer and sentences from the full content
        sentences = []
        if expected_answer:
        ...
        # Calculate ROUGE scores against focused expected answer
        ...
        # Also score against individual sentences
        ...
        try:
            # More weight on unigram matches (70%)
    ...
    def save_results_to_csv(self, results):
        ...
        # Save questions and complete answers to a text file
